...
contract WalletInsurance {
    ...
    uint256 private constant BasicInsuranceDuration = 90 days;
    uint256 private constant BasicPolicy = 1e9;
    uint256 private constant StandardInsuranceDuration = 180 days;
    uint256 private constant StandardPolicy = 1e8;
    ...
    function payInsurance() external payable {
        ...
        require(msg.value >= insuredAmount, "The amount provided is not sufficient.");
